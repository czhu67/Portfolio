...
var Projects = (props) => (
  <div id="projects" className="frame">
    ...
    <div id="martell" className="project">
      <a href="https://github.com/RFCE2209-House-Martell/je-m-appelle-martell/" target="_blank" className="project">Je M'appelle Martell<AiOutlineLink className="linkIcon"/></a>
      <div className="description">Je M'appelle Martell is an e-commerce web application integrated with an existing RESTful API. My team of 4 broke the website down into 4 main components, and I took responsibility for the Overview section (pictured). This project involved sending GET/POST requests to the API using Axios, React Hooks, and CSS. I was particularly proud of implementing the zoom view, where users could click the image for a pop-up magnifying class. We operated on daily stand-up meetings and 2-day sprints, ultimately completing this front-end project in 2-3 weeks.</div>
      <Carousel name="martell" photos={props.allPhotos.martell} zoom={props.zoom} setZoom={props.setZoom} setExpanded={props.setExpanded}/>
    </div>
    <div id="watermelon" className="project">
      <a href="https://caitlinzhu.itch.io/watermeloncatch" target="_blank" className="project">Watermelon Catch<AiOutlineLink className="linkIcon"/></a>
    ...
    <div id="bell" className="project">
      <a href="https://www.bellflight.com/support/mybell" target="_blank" className="project">MyBell Customer Portal Landing Page<AiOutlineLink className="linkIcon"/></a>
